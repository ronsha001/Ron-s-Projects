...
<body>
    <div class="center">
        ...
        <form action="login.php" method="POST">
            ...
            <div class="signup_link"><a href="forgotPass.php">Forgot Password?</a></div>
            <input type="submit" value="Login">
            <div class="signup_link">
                Not a member? <a href="createAccount.php">Signup</a>
            </div>
            <div class="signup_link">
                Continue as a Guest <a href="SelfProjects/index.php">Continue</a>
            </div>
        </form>
